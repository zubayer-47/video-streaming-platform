        ...
        <div className="max-w-full">
          <Link to={'/'} className="relative">
            ...
            <div className="absolute bottom-1 right-1 flex gap-1">
              <p className="bg-gray-900/95 text-white rounded-md py-1 px-1.5 text-xs tracking-wide">7 .6M</p>
          ...
          <div className="grid grid-cols-8 gap-2 place-items-center mt-2">
            ...
            <Link to='/' className="font-semibold text-sm tracking-wide col-span-7">
          ...
          <div className="grid grid-cols-8 place-items-start items-center">
            <div className="col-start-2 col-span-7 w-full flex justify-between mt-2">
              <Link to={'/'} className="text-sm text-gray-700 tracking-wide">{channelName.length > 25 ? channelName.split('').slice(0, 25).join('') + '...' : channelName}</Link>
